    ...
    public partial class Parser 
    {
        ...
        private void ParsePass_Declaration(ParseNode parent) // NonTerminalSymbol: Pass_Declaration
        {
            ...
            if (tok.Type != TokenType.OpenBracket) {
             ...
             // Concat Rule
            tok = scanner.LookAhead(TokenType.VertexShader, TokenType.HullShader, TokenType.DomainShader, TokenType.GeometryShader, TokenType.PixelShader, TokenType.CullMode, TokenType.FillMode, TokenType.AlphaBlendEnable, TokenType.SrcBlend, TokenType.DestBlend, TokenType.BlendOp, TokenType.ColorWriteEnable, TokenType.DepthBias, TokenType.SlopeScaleDepthBias, TokenType.ZEnable, TokenType.ZWriteEnable, TokenType.ZFunc, TokenType.MultiSampleAntiAlias, TokenType.ScissorTestEnable, TokenType.StencilEnable, TokenType.StencilFail, TokenType.StencilFunc, TokenType.StencilMask, TokenType.StencilPass, TokenType.StencilRef, TokenType.StencilWriteMask, TokenType.StencilZFail); // ZeroOrMore Rule
            while (tok.Type == TokenType.VertexShader
                || tok.Type == TokenType.HullShader
                || tok.Type == TokenType.DomainShader
                || tok.Type == TokenType.GeometryShader
                ...
                || tok.Type == TokenType.StencilZFail)
            {
                ...
                { // Choice Rule
                    case TokenType.VertexShader:
                        ...
                        break;
                    case TokenType.HullShader: //JSandusky
                        ParseHullShader_Pass_Expression(node);
                        break;
                    case TokenType.DomainShader: //JSandusky
                        ParseDomainShader_Pass_Expression(node);
                        break;
                    case TokenType.GeometryShader: //JSandusky
                        ParseGeometryShader_Pass_Expression(node);
                        break;
                    ...
                    case TokenType.StencilZFail:
                        ...
                        break;
                    default:
                        tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected VertexShader, HullShader, DomainShader, GeometryShader, PixelShader, CullMode, FillMode, AlphaBlendEnable, SrcBlend, DestBlend, BlendOp, ColorWriteEnable, DepthBias, SlopeScaleDepthBias, ZEnable, ZWriteEnable, ZFunc, MultiSampleAntiAlias, ScissorTestEnable, StencilEnable, StencilFail, StencilFunc, StencilMask, StencilPass, StencilRef, StencilWriteMask, or StencilZFail.", 0x0002, tok));
                        break;
                } // Choice Rule
            tok = scanner.LookAhead(TokenType.VertexShader, TokenType.HullShader, TokenType.DomainShader, TokenType.GeometryShader, TokenType.PixelShader, TokenType.CullMode, TokenType.FillMode, TokenType.AlphaBlendEnable, TokenType.SrcBlend, TokenType.DestBlend, TokenType.BlendOp, TokenType.ColorWriteEnable, TokenType.DepthBias, TokenType.SlopeScaleDepthBias, TokenType.ZEnable, TokenType.ZWriteEnable, TokenType.ZFunc, TokenType.MultiSampleAntiAlias, TokenType.ScissorTestEnable, TokenType.StencilEnable, TokenType.StencilFail, TokenType.StencilFunc, TokenType.StencilMask, TokenType.StencilPass, TokenType.StencilRef, TokenType.StencilWriteMask, TokenType.StencilZFail); // ZeroOrMore Rule
            }
        ...
        private void GenericShader_Pass_Expression(ParseNode parent, String exprString, TokenType parseExpr, TokenType shaderType)
        {
            ...
            // Concat Rule
            tok = scanner.Scan(shaderType); // Terminal Rule: VertexShader
            n = node.CreateNode(tok, tok.ToString());
            node.Token.UpdateRange(tok);
            node.Nodes.Add(n);
            if (tok.Type != shaderType)
            {
        ...
        {
            GenericShader_Pass_Expression(parent, "VertexShader_Pass_Expression", TokenType.VertexShader_Pass_Expression, TokenType.VertexShader);
        } // NonTerminalSymbol: VertexShader_Pass_Expression

        private void ParseHullShader_Pass_Expression(ParseNode parent) // NonTerminalSymbol: GeometrySader_Pass_Expression
        {
            GenericShader_Pass_Expression(parent, "HullShader_PassExpression", TokenType.HullShader_Pass_Expression, TokenType.HullShader);
        } // NonTerminalSymbol: GeomtryShader_Pass_Expression

        private void ParseDomainShader_Pass_Expression(ParseNode parent) // NonTerminalSymbol: GeometrySader_Pass_Expression
        {
            GenericShader_Pass_Expression(parent, "DomainShader_PassExpression", TokenType.DomainShader_Pass_Expression, TokenType.DomainShader);
        } // NonTerminalSymbol: GeomtryShader_Pass_Expression

        private void ParseGeometryShader_Pass_Expression(ParseNode parent) // NonTerminalSymbol: GeometrySader_Pass_Expression
        {
            GenericShader_Pass_Expression(parent, "GeometryShader_PassExpression", TokenType.GeometryShader_Pass_Expression, TokenType.GeometryShader);
        } // NonTerminalSymbol: GeomtryShader_Pass_Expression

        private void ParsePixelShader_Pass_Expression(ParseNode parent) // NonTerminalSymbol: PixelShader_Pass_Expression
        {
            GenericShader_Pass_Expression(parent, "PixelShader_Pass_Expression", TokenType.PixelShader_Pass_Expression, TokenType.PixelShader);
